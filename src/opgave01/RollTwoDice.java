...
public class RollTwoDice {
    ...
    private static void printStatistics() {
        ...
        System.out.println("\nDen totale sum af alle terningekastene er: " + sum);
        System.out.println("\nDu har slået de samme antal øjne " + sammeAntalØjne + " Gange");
        System.out.println("\nDet største antal øjne du har slået er: " + størsteØjne);
        System.out.println();
        System.out.println("Du har slået følgende øjne:");
